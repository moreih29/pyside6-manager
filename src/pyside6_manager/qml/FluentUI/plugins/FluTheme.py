...
class FluTheme(QObject):
    ...
    def _refreshColors(self):
        isDark = self._dark()
        self.primaryColor = (
            self._accentColor.lighter if isDark else self._accentColor.dark
        )
        ...
        self.frameColor = (
            QColor(56, 56, 56, int(255 * 0.8))
            if isDark
            else QColor(243, 243, 243, int(255 * 0.8))
        )
        self.frameActiveColor = (
            QColor(48, 48, 48, int(255 * 0.8))
            if isDark
            else QColor(255, 255, 255, int(255 * 0.8))
        )
        self.itemHoverColor = (
            QColor(255, 255, 255, int(255 * 0.06))
            if isDark
            else QColor(0, 0, 0, int(255 * 0.03))
        )
        self.itemPressColor = (
            QColor(255, 255, 255, int(255 * 0.09))
            if isDark
            else QColor(0, 0, 0, int(255 * 0.06))
        )
        self.itemCheckColor = (
            QColor(255, 255, 255, int(255 * 0.12))
            if isDark
            else QColor(0, 0, 0, int(255 * 0.09))
        )
